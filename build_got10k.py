...
class Config:
  ...
  dataset_dir = '../SiamFC-TensorFlow/data/got10k-Curation'
  save_dir = '../SiamFC-TensorFlow/data/'
  ...
  def dataset_iterator(self, video_dirs):
    ...
    for iter_ in range(iter_num):
      ...
      for index in range(num_videos):
        ...
        dest = osp.join('../SiamFC-TensorFlow/data/got10k-Curation', subdirs[-2], subdirs[-1])
